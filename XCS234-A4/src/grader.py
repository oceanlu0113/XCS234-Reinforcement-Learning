...
class Test_1d(GradedTestCase):
    ...
    def test_0(self):
        ...
        self.assertTrue(np.array_equal(learner.mu[0], np.zeros((learner.d, 1))))
        self.assertTrue(np.array_equal(learner.f[0], np.zeros((learner.d, 1))))
    ...
    def test_1(self):
        ...
        self.assertAlmostEqual(low, 0.333, delta=0.01)
